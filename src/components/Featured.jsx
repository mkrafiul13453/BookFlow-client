...
const Featured = async () => {
    ...
    return (
        <section className="bg-[#fffaf5] py-10 dark:bg-slate-950 sm:py-14 md:py-16">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-7 text-center sm:mb-10">
                    ...
                    <p className="mx-auto mt-2 max-w-xl text-xs text-gray-500 dark:text-slate-400 sm:text-sm md:text-base">
